...
RcppExport SEXP _CmultiJoint_dev_logdmultinomCPP(SEXP xSEXP, SEXP sizeSEXP, SEXP probSEXP) {
BEGIN_RCPP
...
RcppExport SEXP _CmultiJoint_dev_runit(SEXP kSEXP, SEXP YarraySEXP, SEXP nrintSEXP, SEXP ntintSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport void R_init_CmultiJoint_dev(DllInfo *dll) {
